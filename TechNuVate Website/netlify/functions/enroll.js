...
exports.handler = async function (event) {
  ...
  if (pricingTier === 'partner') {
    if (!partnerCode) {
      ...
      errors.push('Invalid partner code format. Expected pattern: TNV-followed by numbers (e.g. TNV-123456).');
    }
  }
  ...
  var flutterwaveConfig = {
    ...
    customizations: {
      ...
      description: course + ' — ' + pricingTier.charAt(0).toUpperCase() + pricingTier.slice(1) + ' Pricing',
